...
export default function createRouter<Router extends RouterFactory<BaseConfig>, Proc extends ProcBuilder<BaseConfig>>(
    ...
    return router({
        ...
        createMany: procedure
            ...
            'mutation',
            Proc,
            (typeof $Schema.VerificationTokenInputSchema)['createMany'],
...
export interface ClientType<AppRouter extends AnyRouter, Context = AppRouter['_def']['_config']['$types']['ctx']> {
    ...
    createMany: {
        useMutation: <T extends Prisma.VerificationTokenCreateManyArgs>(
            ...
            'mutateAsync'
        > & {
            mutateAsync: <T extends Prisma.VerificationTokenCreateManyArgs>(
                variables: T,
